package com.codebakers.system.security;
...
public class UserPrincipal implements UserDetails {
	...
	public UserPrincipal(Long id, String name, String username, String email, String password, int is_disabled,
	...
	public static UserPrincipal create(User user) {
		...
		return new UserPrincipal(user.getId(), user.getName(), user.getUsername(), user.getEmail(), user.getPassword(),
				user.getIs_disabled(), authorities);
	}
